...
import WhatIsRamadanSwahili from './WhatIsRamadanSwahili';
...
const WhatIsRamadanPage: NextPage = (): JSX.Element => {
  ...
  const renderContent = () => {
    if (lang === Language.AR) {
      return <WhatIsRamadanArabic />;
    }
    if (lang === Language.SW) {
      return <WhatIsRamadanSwahili />;
    }
    return (
      <div className={classNames(pageStyles.container, styles.contentPage)} dir={getDir(lang)}>
        ...
        <div className={styles.subSection}>
          ...
          <div className={styles.subSection}>
            ...
            food, drink, and sexual relations to focus on spiritual growth and self-discipline. But
            Ramadan is so much more than abstaining; it’s about connecting—to God, to one’s
          ...
          <div className={styles.subSection}>
            <div>
              <i>
                ...
                clear messages giving guidance and distinguishing between right and wrong. So any
                one of you who is present that month should fast, and anyone who is ill or on a
                journey should make up for the lost days by fasting on other days later. God wants
                ease for you, not hardship. He wants you to complete the prescribed period and to
        ...
        <div className={styles.subSection}>
          ...
          <div>
            Have you ever felt the need to pause the chaos of life and reset? Ramadan is the perfect
            opportunity. This month was chosen by God to reveal the Quran, the holy book of Islam,
            to the Prophet Muhammad (peace be upon him). This divine connection makes Ramadan a time
            of heightened spirituality and purpose.
          </div>
          <div className={styles.subSection}>
        ...
        <div className={styles.subSection}>
          ...
          <div>
            What makes Ramadan unique is its intimate link with the Quran. Revealed over 1,400 years
            ago, the Quran is the direct word of God. It’s not just a book but a guide for life,
            offering wisdom, comfort, and answers to life’s deepest questions.
          </div>
          <div className={styles.subSection}>
            During Ramadan, Muslims dedicate extra time to reading, reciting, and reflecting on the
            Quran. Special nightly prayers called Taraweeh are held, where the Quran is recited in
            beautiful, melodic tones. This deep immersion in the Quran’s message elevates Ramadan
            from a sacred observance into a profound journey of self-discovery, spiritual renewal,
            and reconnection with God, providing a chance to shed bad habits, realign the soul, and
        ...
        <div className={styles.subSection}>
          ...
          <div>
            Even if you’re not Muslim, Ramadan holds universal lessons. Have you ever wondered what
            it means to live with mindfulness? To practice gratitude even in moments of challenge?
            To seek clarity about your place in the world? These are the questions Ramadan invites
            us all to reflect upon.
          </div>
          <div className={styles.subSection}>
            <ul>
              <li>
                What would happen if you paused for moments throughout the day to express gratitude
                to your Creator?
              </li>
              <li>
        ...
        <div className={styles.subSection}>
          ...
          <div>
            ...
            the Quran for yourself. Listen to its recitation, read its meaning, and discover how its
            timeless guidance can illuminate your path.
          </div>
          <div className={styles.subSection}>
            Ramadan is a reminder that the soul’s nourishment is just as vital as the body’s.
            Whether you’re fasting or simply curious, this month offers a chance to reflect, renew,
            and reconnect. What could be more powerful than a fresh start for your soul?
          </div>
        </div>
        <div className={styles.subSection}>
